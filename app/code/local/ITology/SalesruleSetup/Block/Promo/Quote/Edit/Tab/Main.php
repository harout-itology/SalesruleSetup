...
class ITology_SalesruleSetup_Block_Promo_Quote_Edit_Tab_Main extends Mage_Adminhtml_Block_Widget_Form      implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('level', 'text', array(
            'name' => 'level',
            'label' => Mage::helper('salesrule')->__('Rule Level'),
            'title' => Mage::helper('salesrule')->__('Rule Level'),
        ));
